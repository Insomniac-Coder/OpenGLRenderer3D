...
void IndexedModels::CalcNormals()
{
...
IndexedModels OBJModel::ToIndexedModel()
{
	IndexedModels result;
	IndexedModels normalModel;
...
unsigned int OBJModel::FindLastVertexIndex(const std::vector<OBJIndex*>& indexLookup, const OBJIndex* currentIndex, const IndexedModels& result)
{
